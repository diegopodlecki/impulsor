...
export const landingPages: Record<string, LandingConfig> = {
  gimnasio: {
    slug: "gimnasio",
    title: "Página web para gimnasios que quieren más alumnos",
    heroTitle: "Llená tu gimnasio con una web que atrae alumnos todos los días",
    heroSubtitle: "No pierdas clientes por no tener presencia online profesional. Mostrá tus clases, horarios e instalaciones y convertí visitas en inscripciones reales.",
    ...
    services: [
      ...
      { title: "Formulario de inscripción", description: "Formulario simple para que deixe seus dados.", icon: "form" },
    ],
    ...
    aboutText: "Diseño páginas para gyms que necesitan más alunos y uma presença digital que realmente venda.",
    aboutPoints: [
    ...
    formSubtitle: "Te respondo con una propuesta pensamentoada para conseguir más alumnos.",
    finalCtaTitle: "Empezá a recibir nuevos alunos hoy",
  ...
  "personal-trainer": {
    ...
    title: "Página web para entrenadores personales que quieren más clientes",
    heroTitle: "Convertí tu experiencia en más clientes con una web que vende",
    heroSubtitle: "No pierdas clientes por no tener presencia online profesional. Mostrá tu método, tus resultados y por qué sos la persona correcta para entrenar.",
  ...
  nutricionista: {
    slug: "nutricionista",
    title: "Página web para nutricionistas que quieren más pacientes",
    heroTitle: "Generá más consultas con una web que vende confianza",
    heroSubtitle: "No pierdas clientes por no tener presencia online profesional. Explicá tu enfoque, mostrá tus servicios y facilitá que las personas agenden consulta.",
    ...
    formSubtitle: "Te respondo con una propuesta penséeada para conseguir más pacientes.",
  ...
  psicologo: {
    slug: "psicologo",
    title: "Página web para psicólogos que quieren más consultas",
    heroTitle: "Transmití confianza y recibí más consultas con tu web",
    heroSubtitle: "No pierdas clientes por no tener presencia online profesional. Una web clara, cálida y profesional ayuda a que la persona se anime a dar el siguiente paso.",
    ...
    formSubtitle: "Te respondo con una proposta penséeada para captar más pacientes.",
  ...
  "estetica-corporal": {
    ...
    title: "Página web para centros de estética que quieren más consultas",
    ...
    formSubtitle: "Te respondo con una proposta penséeada para conseguir más consultas.",
  ...
  emprendedor: {
    ...
    formSubtitle: "Te respondo con uma propuesta penséeada para vender mejor.",
    finalCtaTitle: "Empezá a convertir visitas en clientes",
    finalCtaText: "Si querés una web simple, clara y pensamentoada para vender, esta base te sirve para arrancar.",
