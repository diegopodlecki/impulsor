...
export const landingConfigsV2: Record<string, LandingPageConfig> = {
  ...
  'personal-trainer': {
    hero: {
      badge: '🤖 Bot WhatsApp para Personal Trainers',
      title: 'Agenda automática de clientes por WhatsApp',    
      subtitle: 'Tu bot responde consultas, envía tarifas y agenda turnos mientras vos entrenas. Sin hacer nada. 24/7.',
      ctaText: 'Activar bot gratis',
      ...
      layout: 'split',
      stats: [
        { value: '+40%', label: 'Más consultas en 30 días' },
        { value: '100%', label: 'Automático' },
        { value: '24/7', label: 'Disponible siempre' },
      ],
    },
    servicios: {
      title: 'Cómo funciona tu bot WhatsApp',
      subtitle: 'Automatización inteligente para entrenadores personales',
      description: 'Tu cliente escribe, el bot responde automáticamente. Sin que vos tengas que estar pegado al teléfono.',
      items: [
        {
          icon: '💬',
          title: 'Responde automáticamente',
          description: 'Cliente pregunta "¿Cuánto cuesta?" → Bot responde en segundos con tus tarifas y especialidad.',
          badges: 'Automático',
        ...
        },
        {
          ...
          description: 'Cliente elige horario → Se confirma solo en Google Calendar. Vos ves el turno confirmado.',
          image: 'https://images.unsplash.com/photo-1581009146145-b5ef050c149a?w=800&h=600&fit=crop',
        },
        {
          icon: '📲',
          title: 'Envía tarifas y info',
          description: 'Con un click envías tu lista de precios, especialidades y metodología. Sin escribir cada vez.',
          image: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=800&h=600&fit=crop',
        },
        {
          icon: '🔔',
          title: 'Recordatorios automáticos',
          description: 'Tu cliente recibe recordatorio 24h antes del turno. Menos clientes que no aparecen.',
    ...
    diferencial: {
      ...
      description: 'Todos recibimos 50+ mensajes de WhatsApp diarios preguntando lo mismo. Esto te libera.',   
      items: [
        {
          icon: '⚡',
          title: 'No pierdes tiempo respondiendo',
          description: 'El bot responde automáticamente. Vos solo confirmás y entrenás.',
          wrong: 'Ahora respondes 100 mensajes idénticos por día'
        },
        {
          icon: '📊',
          title: 'Más clientes de mejor calidad',
          description: 'Llegan clientes que ya saben tus tarifas y saben qué quieren. No curiosos.',
          wrong: 'Muchas consultas que no cierran'
        },
        {
          icon: '✅',
          title: 'Menos no-shows',
          description: 'Recordatorios automáticos. Tu cliente no se olvida del turno.',
          wrong: 'Turnos agendados que no aparecen'
        },
      ],
      resultadoPromesa: 'El resultado',
      resultadoValor: 'Más clientes, menos trabajo. Desde hoy.',
    },
    beneficios: {
      title: 'Lo que conseguís',
      subtitle: 'Resultados reales para tu entrenamiento',
      description: '',
      items: [
        {
          icon: '⏰',
          title: 'Ahorro de tiempo',
          description: 'No más escribir tarifas 50 veces por día. El bot lo hace por vos.',
        },
        {
          icon: '💰',
          title: 'Más ingresos',
          description: 'Con +40% más consultas, tu facturación sube automáticamente.',
        },
        {
          icon: '📱',
          title: 'Profesionalismo',
          description: 'Respuestas inmediatas. Tus clientes sienten que sos una operación seria.',
        },
        {
          icon: '🎯',
          title: 'Menos fricción',
          description: 'El cliente agenda solo. Sin llamadas, sin idas y vueltas.',
        },
        {
          icon: '📊',
          title: 'Estadísticas claras',
          description: 'Ves cuántas consultas recibiste, cuáles convirtieron en ventas.',
        },
        {
          icon: '🌙',
          title: 'Trabaja 24/7',
          description: 'Aunque duermas, tu bot está aceptando consultas.',
        },
      ],
    },
    galeria: {
    ...
    testimonios: {
      title: 'Personal Trainers que usan el bot',
      subtitle: 'Historias reales',
      description: 'De responder WhatsApp todo el día a enfocarse en entrenar.',   
      items: [
        {
          quote: 'Recibía 80 mensajes por día. Ahora el bot responde automáticamente y yo solo confirmo turnos. Liberador.',
          author: 'Carlos Vega',
          role: 'PT · Palermo, CABA',
          avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&q=80',
          rating: 5,
          highlight: '-2 horas/día de WhatsApp',
        },
        {
          quote: 'Pasé de 3 consultas semanales a 8. El bot es como tener una secretaria 24/7.',
          author: 'Martín Díaz',
          role: 'Coach Online · San Isidro',
          avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&h=200&fit=crop&q=80',
          rating: 5,
          highlight: '+8 clientes nuevos/mes',
        },
        {
          quote: 'Las tarifas claras desde el inicio. Ya no pierdo tiempo en consultas que no van a cerrar por precio.',
          author: 'Laura Pérez',
    ...
    ctaFinal: {
      title: 'Activa tu bot esta semana',
