...
export const landingConfigsV2: Record<string, LandingPageConfig> = {
  ...
  'personal-trainer': {
    hero: {
      ...
      backgroundImage: 'https://images.pexels.com/photos-originals.pexels.com/photo-1571019613454-1cb2f99b2d8b?w=1920&h=1080&fit=crop',
      heroImage: 'https://images.pexels.com/photo-1583454110551-21f2fa2afe61?w=800&h=1000&fit=crop',
      layout: 'split',
      stats: [
    ...
    servicios: {
      ...
      items: [
        ...
        },
        {
          ...
          image: 'https://images.pexels.com/photo-1581009146145-b5ef050c149a?w=800&h=600&fit=crop',
        },
        {
          icon: '📋',
          title: 'Planes y precios claros',
          description: 'No más WhatsApps preguntando "cuánto sale". Todo visible, todo claro.',
          image: 'https://images.pexels.com/photo-1517836357463-d25dfeac3438?w=800&h=600&fit=crop',
        },
        {
          icon: '💬',
          title: 'WhatsApp directo',
          description: 'Botón de contacto visible. El alumno te escribe sin fricción, directo a tu WhatsApp.',
          image: 'https://images.pexels.com/photo-1594381898411-846e7d193883?w=800&h=600&fit=crop',
        },
      ],
    },
    diferencial: {
    ...
    galeria: {
      ...
      images: [
        { src: 'https://images.pexels.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=800&fit=crop', alt: 'Entrenamiento', caption: 'Sesión de entrenamiento' },
        { src: 'https://images.pexels.com/photo-1581009146145-b5ef050c149a?w=800&h=800&fit=crop', alt: 'Transformaciones', caption: 'Resultados' },
        { src: 'https://images.pexels.com/photo-1517836357463-d25dfeac3438?w=800&h=800&fit=crop', alt: 'Planes', caption: 'Planes claros' },
        { src: 'https://images.pexels.com/photo-1583454110551-21f2fa2afe61?w=800&h=800&fit=crop', alt: 'WhatsApp', caption: 'Contacto directo' },
      ],
    },
    testimonios: {
  ...
  psicologo: {
    hero: {
      ...
      ctaSecondaryText: 'Ver ejemplos',
      backgroundImage: 'https://images.pexels.com/photo-1551836022-d5d88e9218df?w=1920&h=1080&fit=crop',
      heroImage: 'https://images.pexels.com/photo-1573497019940-1c28c88b4f3e?w=800&h=1000&fit=crop',
      layout: 'split',
      stats: [
      ...
      items: [
        {
          ...
          badges: 'Credenciales',
          image: 'https://images.pexels.com/photo-1551836022-d5d88e9218df?w=800&h=600&fit=crop',
        },
        {
          icon: '🧠',
          ...
          image: 'https://images.pexels.com/photo-1506812574058-fc75fa93fead?w=800&h=600&fit=crop',
        },
        {
          icon: '📱',
          title: 'Modalidades claras',
          description: 'Presencial, online, híbrido. Cada uno con horarios y costos visibles.',
          image: 'https://images.pexels.com/photo-1582750433449-648b12736484?w=800&h=600&fit=crop',
        },
        {
          icon: '💬',
          title: 'Contacto simple',
          description: 'Formulario o WhatsApp. Sin fricción, sin preguntas innecesarias.',
          image: 'https://images.pexels.com/photo-1573497019940-1c28c88b4f3e?w=800&h=600&fit=crop',
        },
      ],
    },
    diferencial: {
    ...
    galeria: {
      ...
      images: [
        { src: 'https://images.pexels.com/photo-1551836022-d5d88e9218df?w=800&h=800&fit=crop', alt: 'Consultorio', caption: 'Tu consultorio' },
        { src: 'https://images.pexels.com/photo-1506812574058-fc75fa93fead?w=800&h=800&fit=crop', alt: 'Profesional', caption: 'Tu perfil' },
        { src: 'https://images.pexels.com/photo-1582750433449-648b12736484?w=800&h=800&fit=crop', alt: 'Online', caption: 'Terapia online' },
        { src: 'https://images.pexels.com/photo-1573497019940-1c28c88b4f3e?w=800&h=800&fit=crop', alt: 'Contacto', caption: 'Contacto simple' },
      ],
    },
    testimonios: {
  ...
  nutricionista: {
    hero: {
      ...
      ctaText: 'Quiero más pacientes',
      ctaSecondaryText: 'Ver ejemplos',
      backgroundImage: 'https://images.pexels.com/photo-1490645935967-10de6ba17061?w=1920&h=1080&fit=crop',
      heroImage: 'https://images.pexels.com/photo-1556910103-1c02745aae4d?w=800&h=1000&fit=crop',
      layout: 'split',
      stats: [
  ...
  gimnasio: {
    hero: {
      ...
      ctaSecondaryText: 'Ver ejemplos',
      backgroundImage: 'https://images.pexels.com/photo-1534438327276-14e5300c3a48?w=1920&h=1080&fit=crop',
      heroImage: 'https://images.pexels.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=1000&fit=crop',
      layout: 'split',
      stats: [
      ...
      items: [
        {
          ...
          badges: 'Más popular',
          image: 'https://images.pexels.com/photo-1534438327276-14e5300c3a48?w=800&h=600&fit=crop',
        },
        {
          icon: '📸',
    ...
    galeria: {
      ...
      images: [
        { src: 'https://images.pexels.com/photo-1534438327276-14e5300c3a48?w=800&h=800&fit=crop', alt: 'Entrenamiento', caption: 'Tu espacio' },
        { src: 'https://images.pexels.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=800&fit=crop', alt: 'Entrenador', caption: 'Tu perfil' },
        { src: 'https://images.pexels.com/photo-1517836357463-d25dfeac3438?w=800&h=800&fit=crop', alt: 'Entrenamiento', caption: 'Clases' },
        { src: 'https://images.pexels.com/photo-1581009146145-b5ef050c149a?w=800&h=800&fit=crop', alt: 'Pesas', caption: 'Planes' },
      ],
    },
    testimonios: {
  ...
  'estetica-corporal': {
    hero: {
      ...
      ctaSecondaryText: 'Ver ejemplos',
      backgroundImage: 'https://images.pexels.com/photo-1560750588-73207b1ef5b8?w=1920&h=1080&fit=crop',
      heroImage: 'https://images.pexels.com/photo-1522335789203-aabd1fc54bc9?w=800&h=1000&fit=crop',
      layout: 'split',
      stats: [
      ...
      items: [
        {
          ...
          badges: 'Más popular',
          image: 'https://images.pexels.com/photo-1560750588-73207b1ef5b8?w=800&h=600&fit=crop',
        },
        {
          icon: '📸',
          title: 'Antes y después',
          description: 'Resultados reales de tus tratamientos. Generá deseo con evidencia.',
          image: 'https://images.pexels.com/photo-1522335789203-aabd1fc54bc9?w=800&h=600&fit=crop',
        },
        {
          icon: '💎',
          title: 'Tu espacio premium',
          description: 'Fotos profesionales de tu centro. La primera impresión se genera antes de llegar.',
          image: 'https://images.pexels.com/photo-1487412947147-5cebf100ffc2?w=800&h=600&fit=crop',
        },
        {
          icon: '📱',
          title: 'Reserva por WhatsApp',
          description: 'Botón directo a tu WhatsApp. La clienta reserva sin llamar, sin esperar.',
          image: 'https://images.pexels.com/photo-1598524374912-6e92a4e0dd95?w=800&h=600&fit=crop',
        },
      ],
    },
    diferencial: {
    ...
    galeria: {
      ...
      images: [
        { src: 'https://images.pexels.com/photo-1560750588-73207b1ef5b8?w=800&h=800&fit=crop', alt: 'Tratamientos', caption: 'Tratamientos' },
        { src: 'https://images.pexels.com/photo-1522335789203-aabd1fc54bc9?w=800&h=800&fit=crop', alt: 'Resultados', caption: 'Antes y después' },
        { src: 'https://images.pexels.com/photo-1487412947147-5cebf100ffc2?w=800&h=800&fit=crop', alt: 'Espacio', caption: 'Tu espacio' },
        { src: 'https://images.pexels.com/photo-1598524374912-6f40a6c4b22e?w=800&h=800&fit=crop', alt: 'Reserva', caption: 'Reserva online' },
      ],
    },
    testimonios: {
