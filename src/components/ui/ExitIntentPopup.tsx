  ...
  if (!isVisible) {
    return (
      <button
        ...
        className="fixed bottom-24 right-5 z-40 inline-flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-white/10 text-white/60 transition-all duration-300 hover:bg-white/20 hover:text-white hover:scale-110"
        title="¿Necesitas una propuesta? Hablemos"
      >
