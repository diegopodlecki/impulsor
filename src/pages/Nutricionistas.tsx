...
const TESTIMONIALS = [
  {
    quote: "Mi agenda estaba siempre vacía. En 6 semanas ya tenía lista de espera. Mis pacientes me encuentran por Google.",
    author: "Ana Martínez",
    ...
    <main className="min-h-screen bg-gradient-to-b from-emerald-50/50 via-white to-teal-50/30 text-slate-800 overflow-hidden">
      ...
      <section className="relative py-32 lg:py-40 bg-gradient-to-b from-emerald-50/30 to-white">
        <div className="container">
          <div className="text-center mb-20">
            <h2 className="text-4xl sm:text-5xl font-bold tracking-tight mb-6">
              Nutricionistas con agenda llena
            </h2>
          </div>

          <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
            {TESTIMONIALS.map((item, idx) => (
              <div key={idx} className="p-10 rounded-3xl bg-white shadow-lg shadow-slate-200/50 border border-slate-100 hover:border-emerald-200 hover:shadow-xl hover:shadow-emerald-500/10 transition-all">
