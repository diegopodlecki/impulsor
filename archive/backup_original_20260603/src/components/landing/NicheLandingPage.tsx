...
export function NicheLandingPage({ config }: { config: LandingConfig }) {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden text-foreground" style={{ background: theme.pageBackground, color: "#F5F5F5" }}>
      ...
      <section id="inicio" className="section-container scroll-mt-24 section-padding">
        <div className="grid gap-10 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
          <div>
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              <Button asChild size="lg" className="bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 font-semibold">
                <a href="#contacto" data-analytics-cta="landing-hero-want-web">
            ...
            <div className="mt-10 grid gap-3 sm:grid-cols-3">
              {voice.heroStats.map((item) => (
                <div key={item.value} className="card-base p-4">
            ...
            {(config.location || config.schedule) && (
      ...
      <section className="section-container section-padding-tight">
        <div className="section-bg">
          <div className="relative z-10 flex flex-col items-center justify-center text-center gap-6">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.24em] mb-2" style={{ color: accent }}>
                ¿Te gusta lo que ves?
              </p>
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-white">
                Contanos sobre tu negocio
              </h2>
              <p className="mt-3 text-base leading-6 text-white/80 max-w-2xl">
                Completá el formulario y te haremos una propuesta personalizada. Te respondo en menos de 24 horas.
              </p>
            </div>
            
            <Button asChild size="lg" className="bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 shadow-lg">
              <a href="#contacto" data-analytics-cta="landing-banner-want-web">
                <Sparkles className="mr-2 h-5 w-5" />
      ...
      <section id="servicios" className="section-container scroll-mt-24 section-padding">
        <SectionTitle
          eyebrow="Ofertas"
        ...
        <div className="mt-12 grid-responsive">
      ...
      {config.sectionImages && config.sectionImages.length > 0 && (
        <section id="galeria" className="section-container scroll-mt-24 section-padding">
          <SectionTitle
            eyebrow="Galería visual"
            title="Imágenes premium adaptadas a tu rubro"
            description="Cada landing incluye imágenes reales y modernas optimizadas para destacar en tu industria"
            accent={accent}
          />

          <div className="mt-12 grid gap-cards md:grid-cols-2">
            {config.sectionImages.map((imageUrl, index) => (
              <div
                key={index}
              ...
              >
                ...
                <div
                  ...
                  style={{ background: `linear-gradient(135deg, ${theme.primary}ee, ${theme.surface}ee)` }}
                >
                  <div className="text-center">
                    <p className="text-sm font-semibold text-white/90">Imagen {index + 1} de {config.sectionImages.length}</p>
                    <p className="text-xs text-white/60 mt-2">Optimizada para tu rubro</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div
            className="mt-12 section-bg"
            style={{
              background: `linear-gradient(135deg, ${theme.primary}88 0%, ${theme.surface}88 100%)`,
            }}
          >
            <div className="flex flex-col items-center justify-center text-center gap-4">
              <p className="text-sm font-semibold uppercase tracking-[0.24em]" style={{ color: accent }}>
                Material visual premium
              </p>
              <h3 className="text-2xl sm:text-3xl font-bold tracking-tight text-white max-w-2xl">
                Todo el material de imágenes está incluido en tu landing
              </h3>
              <p className="mt-2 text-base leading-6 text-white/80 max-w-2xl">
                Las imágenes se adaptan a tu rubro y se actualizan según tus necesidades. Ideal para redes sociales, miniaturas y previsualizaciones.
              </p>
            </div>
          </div>
        </section>
      ...
      <section id="testimonios" className="section-container scroll-mt-24 section-padding">
        <SectionTitle
          eyebrow="Testimonios"
      ...
      <section id="resultados" className="section-container scroll-mt-24 section-padding">
        <SectionTitle
      ...
      <section id="contacto" className="section-container scroll-mt-24 section-padding">
